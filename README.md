...
## Compatibility
In theory should be compatible with any desktop that can run python, has been tested on Windows 11 And Linux, though it appears there are some issues working with fonts for Linux, functionality is 100% the same though!
